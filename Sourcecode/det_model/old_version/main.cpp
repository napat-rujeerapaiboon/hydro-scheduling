...
int main (int argc, const char *argv[], const char *param_env[]) {
    ...
    int v = atoi (argv[1]);
    switch (v) {
        case 25:    deterministic__percentage_of_spot__factor = 0.25; break;
        case 50:    deterministic__percentage_of_spot__factor = 0.5; break;
        case 75:    deterministic__percentage_of_spot__factor = 0.75; break;
        case 100:   deterministic__percentage_of_spot__factor = 1.0; break;
